...
export const SHARED_STATE = {
  ...
  customSources: [
    {
      ...
      scope: { tickers: ["CS CN", "HBM US", "TGB US"], themes: ["copper"] },
    ...
    },
    {
      ...
      url: "https://x.com/miningobserver",
      title: "@miningobserver",
      scope: { tickers: ["CS CN", "HBM US"], themes: ["copper"] },
  ...
  themes: [
    ...
    { id: "exchanges", label: "Exchanges", active: true },
  ],
