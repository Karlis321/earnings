      ...
      <div className="flex flex-col gap-4">
        ...
        <Panel eyebrow="Role">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-[14px] text-tx capitalize">{role}</div>
              <div className="mt-1 text-[12.5px] text-tx-mid">
                Toggle to preview the read-only surface. Real auth lands in P9.
              </div>
            </div>
            <button
              onClick={toggle}
              className="rounded-button border border-bd2 bg-s2 px-3 py-[7px] text-[12.5px] text-tx hover:bg-s3"
            >
              Toggle role
            </button>
          </div>
        ...
        <Panel eyebrow="Feature flags">
          ...
          <p className="mt-3 text-[12px] text-tx-mid">
            LLM enrichment is <strong>OFF</strong> — $0 mode. Enable when the
            monthly Anthropic ceiling is signed off.
          </p>
        </Panel>
