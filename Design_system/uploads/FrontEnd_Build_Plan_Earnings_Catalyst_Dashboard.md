# Front-End Build Plan — BluOr Earnings & Catalyst Dashboard
...
- **P8-T3** Manual Value Entry: **mandatory source + as-of** validation, method default, supersede/versioning. Save 🔴 earnings/guidance store write.
